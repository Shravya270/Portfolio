      ...
      {showAction && (
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 350" className="w-80 h-auto">
            {/* Main Body */}
            <rect x="0" y="90" width="500" height="230" fill="black" rx="5" />
            {/* Horizontal lines */}
            ...
            >
              ...
              <pattern id="stripes" width="60" height="60" patternUnits="userSpaceOnUse" patternTransform="skewX(-20)">
